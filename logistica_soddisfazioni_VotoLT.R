...
plot( dati$Voto_LT, Sodd_compl, pch = ifelse( Sodd_compl >= 8,2,4),
      col = ifelse( Sodd_compl>=8 , 'forestgreen', 'red' ),
...
mod = glm( Sodd_bin ~ dati$Voto_LT, family = binomial( link = logit ) )
summary( mod )
